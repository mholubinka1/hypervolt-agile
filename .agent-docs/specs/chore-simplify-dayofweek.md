...
- **New file:** `tests/hypervolt/test_model.py` (does not currently exist — this closes a pre-existing coverage gap in the same module this refactor touches, required under the repo's coverage-diff CI gate).
- Cases to cover:
