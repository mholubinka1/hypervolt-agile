...
async def test_resolve_theme_returns_custom_theme_during_its_window() -> None:
...
async def test_resolve_theme_uses_config_list_order_when_custom_windows_overlap() -> (
    None
):
    now = datetime(2026, 3, 15, 12, 0, tzinfo=_LONDON)
    _st_george = LedTheme(
